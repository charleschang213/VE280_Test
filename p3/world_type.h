#ifndef WORLD_TYPE_H
#define WORLD_TYPE_H
#define NO_MAX_PROGRAM_TEST
#define MAX_PROGRAM_TEST_1
#include <string>

using namespace std;

const unsigned int MAXSPECIES = 10; // Max number of species in the
#ifdef NO_MAX_PROGRAM_TEST
const unsigned int MAXPROGRAM = 40; // Max size of a species program
#else
#ifdef MAX_PROGRAM_TEST_1
const unsigned int MAXPROGRAM = 18;
#else
const unsigned int MAXPROGRAM = 17;
#endif
#endif
